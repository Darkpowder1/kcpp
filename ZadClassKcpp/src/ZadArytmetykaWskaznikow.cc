...
void ZadArytmetykaWskaznikow::print_tablica(int* tablica, int rozmiar) {
...
void ZadArytmetykaWskaznikow::reset_tablicy(int* tablica, int rozmiar) {
    for (int i=0; i < rozmiar; i++) {
        tablica[i] = i+1;
    }
}

void ZadArytmetykaWskaznikow::Funkcja1(int* tablica, int rozmiar){
    int* p; 
...
void ZadArytmetykaWskaznikow::run() {
